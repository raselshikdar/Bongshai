      ...
      <main className="flex-1 container py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
            About <span className="text-primary">HaatBazar</span>
          </h1>
          
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-muted-foreground text-lg mb-8">
              HaatBazar is Bangladesh's most trusted online shopping destination, bringing quality products 
              at unbeatable prices directly to your doorstep. Founded with a vision to revolutionize 
              e-commerce in Bangladesh, we are committed to providing an exceptional shopping experience.
            </p>
            ...
            <h2 className="text-2xl font-bold mt-10 mb-6 text-foreground">Why Choose HaatBazar?</h2>
            ...
            <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-6 rounded-xl mt-8">
              ...
              <p className="text-muted-foreground">
                Started in 2024, HaatBazar began as a small initiative to connect local sellers with 
                buyers across Bangladesh. Today, we've grown into a comprehensive marketplace offering 
                everything from fashion and electronics to groceries and home essentials. Our commitment 
